...
# connections through the autoencoder bottleneck in the pytorch VAE example, this is 20
ZDIMS = 20


# ================================== ADDITIONAL FUNCTIONS ==========================================
# I do this so that the MNIST dataset is downloaded where I want it
if not os.path.exists('./pytorch-vae'):
    os.mkdir('./pytorch-vae')
...
def test(epoch):
    ...
    for i, (data, _) in enumerate(test_loader):
        ...
        if i == 0:
            ...
            save_image(comparison.data.cpu(), 'results/reconstruction_' + str(epoch) + '.png',
                       nrow=n)
